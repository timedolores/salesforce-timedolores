({
    ...
    fundFilterChangeHandler: function(component, event, helper) {
        ...
        if (event.getParam("investmentProfile") !== undefined) {
            filterObject.investmentProfile = event.getParam("investmentProfile");
        }
        if (event.getParam("customerSegment") !== undefined) {
            filterObject.customerSegment = event.getParam("customerSegment");
        }
        helper.loadFunds(component);
    },
